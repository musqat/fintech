package com.zerobase.com.zerobase.api.loan.encrypt
...
class EncryptComponent {
    ...
    fun encryptString(encryptString: String): String {
        val encryptedString =
            cipherPkc5(Cipher.ENCRYPT_MODE, secretKey)
    ...
    fun decryptString(decryptString: String): String {
        ...
        return String(cipherPkc5(Cipher.DECRYPT_MODE, secretKey).doFinal(byteString))
    }

    fun cipherPkc5(opMode: Int, secretKey: String): Cipher {
